...
[![Version](https://img.shields.io/badge/version-v1.2.0--dev-blue)](docs/README.md#-更新日志)
...
- 🛡️ **内存队列溢出保护** — 可配置内存队列阈值，超限自动溢出到磁盘队列，防止 OOM
...
| `MEMORY_QUEUE_THRESHOLD` | 0 | 内存队列最大容量（0=不限制） |
